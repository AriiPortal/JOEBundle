...
(function () {
  ...
  */
	function buildGroupForm(parent, description) {
		var formJson = [{ type: 'block', name: 'block1', list: [{
				type: "select",
				name: "options1",
				label: description.selects.options.label,
				options: description.selects.options.options,
				inputWidth: 140
			}, { type: "newcolumn" }, { type: "button", name: "addOption", value: description.buttons.addOption.label, width: 110 }] }, { type: 'block', name: 'block2', list: [{
				type: "multiselect",
				name: "groups",
				options: description.selects.groups,
				inputWidth: 400,
				inputHeight: 250
			}, { type: "newcolumn" }, { type: "button", name: "removeGroup", value: description.buttons.removeGroup.label, width: 110 }] }, { type: 'block', name: 'block3', list: [{
				type: "multiselect",
				name: "options2",
				inputWidth: 250,
				inputHeight: 250
			}, { type: "newcolumn" }, { type: "block", name: "block31", list: [{ type: "button", name: "addEveryToGroup", hidden: true, width: 110 }, { type: "button", name: "addToGroup", value: description.buttons.addToGroup.label, width: 110 }, { type: "button", name: "removeFromGroup", value: description.buttons.removeFromGroup.label, width: 110 }] }, { type: "newcolumn" }, { type: "multiselect", name: "group", inputWidth: 250, inputHeight: 250 }, { type: "newcolumn" }, { type: "block", name: "block32", list: [{ type: "button", name: "newGroup", value: description.buttons.newGroup.label, width: 110 }, { type: "button", name: "applyGroup", value: description.buttons.applyGroup.label, width: 110 }] }] }];
    ...
    */
		...
		function refreshForm() {
			form.getOptions('groups').length == 0 ? form.disableItem('removeGroup') : form.enableItem('removeGroup');
		...
		form.attachEvent('onButtonClick', function (id) {
			...
			} else if (id == 'addEveryToGroup') {} else if (id == 'removeFromGroup') {
