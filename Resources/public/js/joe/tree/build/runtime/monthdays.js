joe.loader.load('utils/binder/entity_binder', function(EntityBinder) {
	...
	function MonthdaysNode (binder) {
		this.binder = binder;
		this.children = {}
		this.monthdaysBinder = new EntityBinder('monthday', binder,
											   'runtime.monthdayCollection');
		...
		this.monthdaysBinder.register(this, monthdaysCbs, { days: true });
	}
	...
	MonthdaysNode.prototype.destroy = function() {
		...
		this.monthdays.unregister(this);
		this.monthdaysBinder.destroy();
