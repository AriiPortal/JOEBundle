...
joe.loader.load('utils/binder/entity_binder', function (EntityBinder) {
	...
	var formDesc = [
		{ type: 'combo', name: 'monitor', label: 'Monitor', labelWidth: 150, width: 140 },
		{ type: 'newcolumn' },
		{ type: 'input', name: 'ordering', label: 'Odering', labelWidth: 150 }
	];

	var ctrlsDesc = [
		{ label: 'Apply Monitor Use', action: applyMonitor },
		{ label: 'New Monitor Use', action: newMonitor },
		{ label: 'Remove Monitor Use', action: removeMonitor }
	];
