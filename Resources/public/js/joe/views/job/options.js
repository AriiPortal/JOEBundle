(function() {
	...
	Options.prototype.setup = function(parent) {
		...
		var str = [
			{ type:"input" , name:"jobScheduler.name", label:"Scheduler ID", labelWidth:140 },
			{ type:"input" , name:"javaOptions", label:"Java Options", labelWidth:140 },
			{ type:"block" , name:"form_block_1", list:[
				{ type:"input" , name:"ignoreSignals", label:"Ignore signals", labelWidth:140 },
				{ type:"newcolumn"   },
				{ type:"button" , name:"add_signal", value:"<- Add <-" },
				{ type:"newcolumn"   },
				{ type:"select" , name:"signal_select", inputWidth:140,
				  options:[
			...
			{ type:"combo" , name:"priority", label:"Priority", labelWidth:140, options:[
			...
			{ type:"select" , name:"visible", label:"Visible", labelWidth:140, options:[
				{ value:"yes", text:"yes" },
				{ value:"no", text:"no" },
				{ value:"never", text:"never" }
			] },
			{ type:"input" , name:"minTasks", label:"Min tasks", labelWidth:140 },
			{ type:"input" , name:"tasks", label:"Tasks", labelWidth:140 },
			{ type:"block" , name:"form_block_2", list:[
				{ type:"input" , name:"timeout", label:"Timeout", labelWidth:140 },
				{ type:"newcolumn"   },
				{ type:"label" , name:"form_label_5", label:"hh:mm:ss"  }
			]  },
			{ type:"block" , name:"form_block_3", list:[
				{ type:"input" , name:"idleTimeout", label:"Idle Timeout", labelWidth:140 },
				{ type:"newcolumn"   },
				{ type:"label" , name:"form_label_2", label:"hh:mm:ss or hh:mm or ss or never"  }
			]  },
			{ type:"block" , name:"form_block_4", list:[
				{ type:"input" , name:"warnIfLongerThan", label:"Warn if longer than", labelWidth:140 },
				{ type:"newcolumn"   },
				{ type:"label" , name:"form_label_3", label:"hh:mm:ss or percentage"  }
			]  },
			{ type:"block" , name:"form_block_5", list:[
				{ type:"input" , name:"warnIfShorterThan", label:"Warn if shorter than", labelWidth:140 },
				{ type:"newcolumn"   },
